...
swiftc -o "$out" tests/supervisor/main.swift tests/supervisor/supervisormainchecks.swift \
  ...
  tests/supervisor/dialoggatechecks.swift tests/supervisor/dialoggatereadingchecks.swift \
  ...
  tests/supervisor/waitspoolchecks.swift \
  ...
  tests/supervisor/transcriptcatchupchecks.swift \
  ...
  Tally/Core/SessionProcessGroups.swift Tally/Core/SessionProcessGroupsFile.swift Tally/Core/MachineLoadRollup.swift \
  ...
  Tally/Core/FootprintTrend.swift Tally/Core/FootprintPeak.swift Tally/Core/MotionStyle.swift \
