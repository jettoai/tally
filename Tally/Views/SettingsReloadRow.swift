...
/// The Settings face of `tally reload`: one button that asks supervised Claude sessions to restart at
    ...
    var body: some View {
        HStack(alignment: .firstTextBaseline) {
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text(L("Each supervised Claude session restarts when it goes idle, so edited hooks and instructions take effect. Conversations continue."))
                    .font(.caption)
