...
<p align="center">
  <img src="assets/screenshot-panel.png" alt="Tally 釘選面板：各 provider 的艦隊儀表把八個帳號（五個 Claude Max、三個 Codex）合池成各自一條每週預算長條，附節奏預測（約可再用 4d 10h；此節奏可持續）與下一筆錯開回充；下方每個帳號各自的卡片顯示 5 小時工作階段、每週、旗艦模型額度窗，含重置時間、接近上限警示，以及標出啟動器目前選擇的紫色智選徽章" width="560">
</p>
