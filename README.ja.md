...
<p align="center">
  <img src="assets/screenshot-panel.png" alt="Tally のピン留めパネル：プロバイダごとのフリートゲージが 8 つのアカウント（Claude Max が 5 つ、Codex が 3 つ）をそれぞれ 1 本の毎週予算バーにまとめ、ペース予測（残り約 4d 10h、このペースなら持続可能）と次の時差回復を表示。その下には各アカウント自身のカードが 5 時間セッション、毎週、最上位モデルの窓をリセット時刻、上限接近の警告、そしてランチャーの現在の選択を示す紫色のスマート選択バッジとともに表示します" width="560">
</p>
