...
func runAccountRowChecks() {
    ...
    check("a rejected credential is described as signed out without inventing an expiry",
          AccountSignIn.detailKey(isDormant: false) == "Signed out. Click to sign in again.")
