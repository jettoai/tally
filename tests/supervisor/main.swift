...
runDroughtChecks()
runCapResumeChecks()
runCapResumeCarryChecks()
runSelfSwitchResumeChecks()
runCapHandoffRunwayChecks()
runSelfUpdateBackgroundChecks()
runCapLimitResetChecks()
runSessionInputChecks()
runSessionSendChecks()
runSessionProjectChecks()
runSessionSendVerbChecks()
runSessionClearChecks()
runDraftStashChecks()
runQuotaKnockChecks()
runDialogGateChecks()
runDialogGateReadingChecks()
