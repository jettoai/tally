...
swiftc -o "$out" tests/statusline/main.swift \
  ...
  TallyCLI/SessionSwitch.swift TallyCLI/SwitchDecision.swift TallyCLI/SwitchRequest.swift TallyCLI/AccountHome.swift TallyCLI/GitRepoRoot.swift TallyCLI/Reload.swift \
