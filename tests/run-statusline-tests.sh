...
swiftc -o "$out" tests/statusline/main.swift \
  ...
  TallyCLI/TranscriptWatcher.swift TallyCLI/NativeModelCommand.swift Tally/Core/LaunchAxisNames.swift TallyCLI/TranscriptFork.swift TallyCLI/OpenTurn.swift \
