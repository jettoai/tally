...
swiftc -o "$work/dump" tests/completion/main.swift \
  TallyCLI/Completion.swift TallyCLI/HarnessCompletion.swift TallyCLI/RepoCompletion.swift TallyCLI/CompletionData.swift TallyCLI/Snapshot.swift TallyCLI/CodexLaunchArgs.swift TallyCLI/AccountPick.swift \
